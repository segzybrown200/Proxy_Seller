...
const conversations: Conversation[] = [
  { id: 'c1', name: 'Amina Bello', lastMessage: 'You just placed an order', time: '20 min ago' },
]
      ...
      >
        <View className="flex-row items-center">
          ...
          <View className="max-w-[80%] ml-2">
            ...
            <Text  className="text-base text-textColor-200 mt-1 font-NunitoLight">
              {item.time}
            </Text>
          </View>
        </View>
    ...
    <SafeAreaView className="flex-1 bg-gray-50 p-5">
        <View className="flex-row items-center mt-10">
          <TouchableOpacity
              ...
              <Text className="text-2xl font-NunitoBold">Notifications</Text>
            </View>    
      ...
      <FlatList
        ...
        ListEmptyComponent={() => (
          <View className="items-center mt-8">
            <Text className="text-gray-400 font-RalewayMedium">No Notifications yet.</Text>
          </View>
        )}
      />
    </SafeAreaView>
